...
#FUNCION PARA CARGAR LOS VALORES EN EL DICCIONARIO, en este caso sera lo que es el numero del estudiante como clave y como valor, el nombre de la materia y la nota que saco en ella
def charge():
    ...
    while pointer1 == "s" or pointer1 == "si" or pointer1 == "S" or pointer1 == "SI":
        ...
        #Hacemos una lista vacia para agregar los valores como tuplas en una lista
        lista = []
        #Hacemos otro puntero para agregar dos valores
        pointer2 = "s"
